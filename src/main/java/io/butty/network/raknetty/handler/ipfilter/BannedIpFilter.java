package io.butty.network.raknetty.handler.ipfilter;

import io.butty.network.raknetty.handler.codec.offline.ConnectionBanned;
...
public class BannedIpFilter extends ChannelInboundHandlerAdapter {
    ...
    private static final Logger LOGGER = LogManager.getLogger(BannedIpFilter.class);
